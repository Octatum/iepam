...
const Footer = () => {
  ...
  return (
    <footer>
      ...
      <FlexLayout flexDirection={['column', 'row', 'row']} flexWrap={['nowrap','wrap','wrap']} width={[1, 1, 1]} order={[0, 0, 0]} mb={4} pt={4} px={[0, 5, 6]} justifyContent="center">
        <Box px={[0, 0, 4]} width={[1, 1 / 2, 1 / 3]} my={[3, 3, 0]}>
          <Box mb={3}>
        ...
        <Box px={[0, 0, 4]} width={[1, 1 / 2, 1 / 3]} order={[1, 1, 0]} my={[3, 3, 0]}>
          <Box mb={3}>
            <Centered size={2} bold>
              Compromiso
            </Centered>
        ...
        <Box px={[0, 0, 4]} width={[1, 1 / 2, 1 / 3]} order={[0, 2, 0]} my={[3, 3, 0]}>
          <Box mb={3}>
            <Centered size={2} bold>
              Secciones
            </Centered>
        ...
        <Box px={[4, 4, 0]} width={[1, 1 / 2, 1]} order={[3, 3, 0]} my={[2, 0, 0]} mb={4}>
          <Box mb={1} >
