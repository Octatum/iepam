  ...
  return (
    <AppLayout>
      ...
      <Flex>
        ...
        <BackgroundBox backgroundColor="darkestGray" width={2 / 5} pl={4} css={{minHeight: '100%'}}>
          <Flex flexDirection="column" css={{ minHeight: '100%', maxHeight: '100%' }}>
            ...
            <ScrollBox py={4}>
              {[1, 2, 3, 4, 5, 6, 7, 8].map(item => (
                <Box py={2}>
                  <Text size={1} color="white" key={item}>{item} Tema Lorem Ipsum is a dummy text</Text>
                </Box>
              ))}
            </ScrollBox>
          </Flex>
