  ...
  courses: [
    {
      ...
      courseDescription:
        'Curso para aprender acerca de la situación actual de nuestro país',
    },
    {
      nombre: 'Crédito para mi negocio',
      link:
        'http://www.cursosinea.conevyt.org.mx/cursos/creditneg/bienvenida.htm',
      courseDescription: 'Técnicas para solicitar y conseguir financiamiento',
    },
    {
      nombre: 'Vida y salud',
      link:
        'http://www.cursosinea.conevyt.org.mx/cursos/vidaysalud1_1/bienvenida.htm',
